            ...
            <div>
                <ul class="navigation-left">
                    ...
                    <li
                        ...
                        @mouseenter="toggleSubMenu"
                        :class="{
                            active: selectedParentMenu == 'User_Management',
                        }"
                        class="nav-item"
                    ...
                    >
                        <a class="nav-item-hold" href="#">
                            ...
                            <span class="nav-text">{{ $t("CRM") }}</span>
                        </a>
                        <div class="triangle"></div>
                    </li>
                    ...
                    <li
                        ...
                        :class="{
                            active:
                                selectedParentMenu == 'subscription_product',
                        }"
                        class="nav-item"
                    ...
                    <li
                        v-show="
                            currentUserPermissions &&
                            currentUserPermissions.includes('assets')
                        "
                        @mouseenter="toggleSubMenu"
                    ...
                    <li
                        v-show="
                            currentUserPermissions &&
                            currentUserPermissions.includes('projects')
                        "
                        @mouseenter="toggleSubMenu"
                    ...
                    <li
                        v-show="
                            currentUserPermissions &&
                            currentUserPermissions.includes('tasks')
                        "
                        @mouseenter="toggleSubMenu"
                    ...
                    <li
                        v-show="
                            currentUserPermissions &&
                            currentUserPermissions.includes('bookings')
                        "
                        @mouseenter="toggleSubMenu"
            ...
            <div ref="sidebarChild">
                ...
                >
                    ...
                    <li
                        ...
                        v-if="
                            currentUserPermissions &&
                            currentUserPermissions.includes('Suppliers_add')
                        "
                    >
                        <router-link
                            tag="a"
                ...
                >
                    <li
                        ...
                        "
                    >
                        <router-link tag="a" class to="/app/crm/dashboard">
                            <i class="nav-icon i-Bar-Chart"></i>
                            <span class="item-name">{{ $t("Dashboard") }}</span>
                        </router-link>
                    </li>
                    ...
                    <li
                        ...
                        "
                    >
                        <router-link tag="a" class to="/app/crm/pipelines">
                            <i class="nav-icon i-Data-Flow"></i>
                            <span class="item-name">{{ $t("Pipelines") }}</span>
                        </router-link>
                    </li>
                    ...
                    <li
                        ...
                        v-if="
                            currentUserPermissions &&
                            currentUserPermissions.includes('crm_deals_view')
                        "
                    >
                        <router-link tag="a" class to="/app/crm/deals">
                            <i class="nav-icon i-File-Clipboard-File--Text"></i>
                            <span class="item-name">{{ $t("Deals") }}</span>
                        </router-link>
                    </li>
                    ...
                    <li
                        ...
                        "
                    >
                        <router-link tag="a" class to="/app/crm/followups">
                            <i class="nav-icon i-Calendar-3"></i>
                            <span class="item-name">{{ $t("Followups") }}</span>
                        </router-link>
                    </li>
                    ...
                    <li
                        ...
                        v-if="
                            currentUserPermissions &&
                            currentUserPermissions.includes('crm_forms_view')
                        "
                    >
                        <router-link tag="a" class to="/app/crm/forms">
                            <i class="nav-icon i-File-Text"></i>
                            <span class="item-name">{{ $t("Forms") }}</span>
                        </router-link>
                    </li>
                    ...
                    <li
                        ...
                        v-if="
                            currentUserPermissions &&
                            currentUserPermissions.includes('crm_contacts_view')
                        "
                    >
                        <router-link tag="a" class to="/app/crm/contacts">
                            <i class="nav-icon i-Business-Mens"></i>
                            <span class="item-name">{{ $t("Contacts") }}</span>
                        </router-link>
                    </li>
                    ...
                    <li
                        ...
                        "
                    >
                        <router-link tag="a" class to="/app/crm/groups">
                            <i class="nav-icon i-Folder"></i>
                            <span class="item-name">{{
                                $t("Contact_Groups")
                            }}</span>
                    ...
                    <li
                        ...
                        v-if="
                            currentUserPermissions &&
                            currentUserPermissions.includes('crm_tags_view')
                        "
                    >
                        <router-link tag="a" class to="/app/crm/tags">
                            <i class="nav-icon i-Price-Tag"></i>
                            <span class="item-name">{{ $t("Tags") }}</span>
                        </router-link>
                    </li>
                </ul>
                ...
                <ul
                    ...
                    :class="{
                        'd-block': selectedParentMenu == 'User_Management',
                    }"
                >
                    <li
                        class="nav-item"
                ...
                >
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'woocommerce_settings' }"
                        >
                            <i class="nav-icon i-Link-2"></i>
                            <span class="item-name">{{
                                $t("WooCommerce_Settings")
                            }}</span>
                        </router-link>
                    </li>
                ...
                >
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'cash_register_report' }"
                        >
                            <i class="nav-icon i-Money-2"></i>
                            <span class="item-name">{{
                                $t("Cash_Register_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'zero_sales_products_report' }"
                        >
                            <i class="nav-icon i-Remove-Bag"></i>
                            <span class="item-name">{{
                                $t("Zero_Sales_Products_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'stock_aging_report' }"
                        >
                            <i class="nav-icon i-Clock"></i>
                            <span class="item-name">{{
                                $t("Stock_Aging_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'stock_transfer_report' }"
                        >
                            <i class="nav-icon i-Back"></i>
                            <span class="item-name">{{
                                $t("Stock_Transfer_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            :to="{ name: 'stock_adjustment_report' }"
                        >
                            <i class="nav-icon i-Edit"></i>
                            <span class="item-name">{{
                                $t("Stock_Adjustment_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'discount_summary_report' }"
                        >
                            <i class="nav-icon i-Billing"></i>
                            <span class="item-name">{{
                                $t("Discount_Summary_Report")
                            }}</span>
                        </router-link>
                    </li>
                    <li
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'customer_loyalty_points_report' }"
                        >
                            <i class="nav-icon i-Love"></i>
                            <span class="item-name">{{
                                $t("Customer_Loyalty_Points_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'draft_invoices_report' }"
                        >
                            <i class="nav-icon i-Receipt"></i>
                            <span class="item-name">{{
                                $t("Draft_Invoices_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'top_suppliers_report' }"
                        >
                            <i class="nav-icon i-Business-ManWoman"></i>
                            <span class="item-name">{{
                                $t("Top_Suppliers_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'service_jobs_report' }"
                        >
                            <i class="nav-icon i-Repair"></i>
                            <span class="item-name">{{
                                $t("Service_Jobs_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            :to="{ name: 'checklist_completion_report' }"
                        >
                            <i class="nav-icon i-Check"></i>
                            <span class="item-name">{{
                                $t("Checklist_Completion_Report")
                            }}</span>
                        </router-link>
                    </li>
                    ...
                    >
                        ...
                        >
                            <i class="nav-icon i-Calendar-4"></i>
                            <span class="item-name">{{
                                $t("Customer_Maintenance_History_Report")
                            }}</span>
                        </router-link>
                    </li>
                </ul>
